    ...
    <div className="">
      <div className="flex items-center justify-between mb-10">
        <div className="flex items-center gap-5">
          <span className="text-lg font-semibold">Cannot Find it?</span>
          <div className="border border-black pl-7 relative rounded-3xl overflow-hidden w-[384px] max-w-sm hidden lg:block">
            <Input
              type="search"
        ...
        >
          New Category <ArrowRight size={12} />
        </Link>
      </div>
