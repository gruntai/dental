...
export default function PatientReactivation() {
  ...
  useEffect(() => {
    ...
    if (processMessages.some(msg => msg.message.includes("Revenue report generated"))) {
    ...
    <div className="h-screen">
      ...
      <div className="flex-1 flex flex-wrap xl:flex-nowrap gap-y-5">
        ...
        <div className="xl:px-5 w-full">
          ...
          {(!showReaction || (currentBoard?.id !== "scan" && currentBoard?.id !== "identify" && currentBoard?.id !== "auto")) && 
            <div className="rounded-lg border p-6 mb-6 space-y-4">
              ...
              <p className="text-xs sm:text-sm text-[#525252]">
                {currentBoard?.id === "connect"
                  ...
                  : (() => {
                    const lastMessage =
                      processMessages[processMessages.length - 1];
              ...
              {processStarted && currentBoard?.id === "import" && showTable && (
                <div className="mt-4">
                  <h3 className="text-sm font-medium mb-2">Imported Patient Records</h3>
              ...
              {processStarted && currentBoard?.id === "import" && !showTable && (
                <div className="mt-4 border rounded-lg p-4">
                  <h3 className="text-sm font-medium mb-2">Importing Patient Records...</h3>
